...
class Profesor(models.Model):
	...
	contrasena = models.CharField(verbose_name='Contraseña', max_length=200)
...
class MatriculaEstudiante(models.Model):
	...
	# Informacion general
	fecha_matricula = models.DateField(verbose_name='Fecha matrícula')
	estudiante = models.ForeignKey(Estudiante)
	estado = models.CharField(max_length=1, 
							choices=ESTADO_ESTUDIANTE, 
							default='A')
	...
	cuotas = models.IntegerField(help_text="Número de cuotas a diferir el valor de la matrícula.", 
								default=1)
	letras = models.FileField(upload_to='/', 
							blank=True, 
							help_text='Letras de cambio en caso de financiación del valor de la matrícula')
...
class Amonestacion(models.Model):
	...
	fecha_amonestacion = models.DateField(verbose_name='Fecha amonestación')
