...
class rpt_ReporteCartera(Report):
    ...
    class band_detail(ReportBand):
        ...
        elements=(
            ...
            ObjectValue(attribute_name = u'inscripcion_ciclo', top=0.1*cm, left=10*cm),
            ObjectValue(attribute_name = u'valor_matricula', top=0.1*cm, left=11.5*cm),
            ObjectValue(attribute_name = u'valor_abonado', top=0.1*cm, left=14*cm),
            ObjectValue(attribute_name = u'valor_saldo', top=0.1*cm, left=16.5*cm),
